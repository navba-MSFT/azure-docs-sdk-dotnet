...
keywords: Azure, dotnet, SDK, API, Azure.Template.LLC, template-llc
author: maggiepint
ms.author: magpint
ms.date: 11/17/2021
ms.topic: reference
...
* Example: `# Azure Batch client library for .NET - Version 1.0.0-alpha.20211117.1 
`

# Azure Template client library for .NET - Version 1.0.0-alpha.20211117.1 
